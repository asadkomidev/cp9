...
import { CONVERSATION_EMPTY } from "@/global/constants/empty";
import { useConversationPrompt } from "./hooks/use-conversation-prompt";

type Props = {};

const ConversationEmpty = (props: Props) => {
  const { onSubmit } = useConversationPrompt();
